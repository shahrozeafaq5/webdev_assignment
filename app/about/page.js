  ...
  return (
    <main className="min-h-screen bg-[#FDFBF7] text-[#292524] relative overflow-hidden">
      ...
      <motion.section 
        ...
        className={`pt-28 pb-24 md:pt-40 md:pb-40 ${CONTAINER_CLASSES}`}
      >
        <div className="max-w-4xl relative">
          <motion.div variants={fadeInUp} className="absolute -left-4 top-1 text-stone-300 text-4xl hidden md:block">
            ✻ 
          </motion.div>
          
          <motion.span variants={fadeInUp} className="text-xs font-bold tracking-[0.3em] uppercase text-stone-500 mb-8 block pl-2 md:pl-0">
            Est. 2025 • The Slow Movement
          </motion.span>
          
          <motion.h1 variants={fadeInUp} className="font-serif text-6xl md:text-8xl leading-[0.95] tracking-tight mb-10 text-stone-900">
      ...
      <section className={`pb-40 ${CONTAINER_CLASSES}`}>
        <div className="flex flex-col md:flex-row gap-16 md:gap-32 items-start">
          ...
          <motion.div 
            ...
            viewport={{ once: true, margin: "-100px" }}
            variants={staggerContainer}
            className="md:w-2/3 space-y-10 text-lg md:text-xl text-stone-600 leading-relaxed font-serif"
          >
            <motion.p variants={fadeInUp} className="relative">
              <span className="float-left text-7xl font-serif leading-[0.7] mr-4 mt-2 text-stone-800 italic">I</span>
            ...
            <motion.p variants={fadeInUp} className="text-xl md:text-2xl text-stone-800 italic font-light">
